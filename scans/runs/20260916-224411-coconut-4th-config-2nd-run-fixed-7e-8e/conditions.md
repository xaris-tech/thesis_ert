# Run 20260916-224411-coconut-4th-config-2nd-run-fixed-7e-8e

- **Captured:** 2026-09-16T22:44:11
- **Code version:** `6762df5-dirty`
- **Label:** Coconut 4th config  (2nd run fixed 7E/8E)

## Conditions

| Field | Value |
|---|---|
| medium | Coconut 3rd config |
| saline_g_per_l | _not recorded_ |
| fill_depth_mm | _not recorded_ |
| water_temp_c | _not recorded_ |
| electrode_protrusion_mm | 3.5 |
| grounding | floating |
